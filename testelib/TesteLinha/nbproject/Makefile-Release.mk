...
LDLIBSOPTIONS=../../dist/Release/Cygwin-Windows/libpasta_cimentada.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/testelinha.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/testelinha.exe: ../../dist/Release/Cygwin-Windows/libpasta_cimentada.a
